...
/*   Updated: 2020/05/14 03:02:33 by abiri            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_gui_area	*ft_load_portal_settings_gui(t_doom_editor *env)
{
	...
	gui_env = &(env->gui);
	if (!(result = ft_new_gui_area((t_rect){1528, 90, 378, 749}, "portal_settings")))
		return (NULL);
    ...
    ft_gui_fit_component(result, ft_gui_new_int_label((t_rect){0, 0, 210, 64},
